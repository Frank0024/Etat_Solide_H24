...
print("distance parcouru entre chaque collision :", distParcouru)
print("nombre de tick entre chaque collision :", dtCollision)
...
plt.boxplot([v_particule,v_particule**2], labels=["A","B"])
