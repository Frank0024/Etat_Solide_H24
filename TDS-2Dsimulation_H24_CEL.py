...
# ax[0].hist(v_norm_normalized, alpha=0.5, bins=16, label=r"$||\vec{v}||$, moyenne = " f"{np.mean(v_norm_normalized)}")
# ax[0].legend(loc="upper right")
# ax[1].hist(v_2_normalized, alpha=0.5, bins=16, label=r"$v^2$")
# ax[1].legend(loc="upper right")
# ax[2].hist(v_x_2_normalized, alpha=0.5, bins=16, label=r"$v_x^2$")
# ax[2].legend(loc="upper right")
# # plt.hist(v_particule**2, label="$v^2$", alpha=0.5)
# # plt.hist(vxParticule, label="$v_x$", alpha=0.5)
# # plt.legend([r"$||\vec{v}||$","$v^2$","$v_x^2$"])
